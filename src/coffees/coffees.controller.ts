...
import { AuthType } from 'src/iam/authentication/enums/auth-tupe.enum';
// import { Permisssions } from 'src/iam/authorization/decorators/permissions.decorator';
...
export class CoffeesController {
  ...
  // @Roles(Role.Admin)
  // @Permisssions(Permission.CreateCoffee)
